...
export const ROSE_SALE: CtaProjectDetail = {
  ...
  timeline: [
    { date: "September 28, 2026", label: "Heads Onboarding" },
    ...
    { date: "TBA", label: "Wave 2 Applications (Florists, Deliveries, Sales)", emphasis: "notable" },
    { date: "TBA", label: "Flower-Wrapping Workshop", emphasis: "notable" },
    { date: "November 5, 2026", label: "2nd General Assembly", emphasis: "notable" },
  ...
  committees: [
    ...
    },
    {
      ...
      items: [
        ...
        [
          { text: "Note: There will be additional requirements for DigiC committee applicants. Kindly follow all pertinent instructions in ", italic: true },
          {
            text: "this document",
            italic: true,
            href: "https://docs.google.com/document/d/1v1f9fZvHbzmIBWXJKkLLCm43MOB3YDo-g0TW1P6c7Rw/edit?usp=sharing",
          },
          { text: ".", italic: true },
        ],
      ],
    },
    {
      ...
      items: [
        ...
        [
          { text: "Note: There will be additional requirements for DocPub committee applicants. Kindly follow all pertinent instructions in ", italic: true },
          {
            text: "this document",
            italic: true,
            href: "https://docs.google.com/document/d/1v1f9fZvHbzmIBWXJKkLLCm43MOB3YDo-g0TW1P6c7Rw/edit?usp=sharing",
    ...
    },
    {
      ...
      items: [
        ...
        [
          { text: "Note: There will be additional requirements for Prod committee applicants. Kindly follow all pertinent instructions in ", italic: true },
          {
            text: "this document",
            italic: true,
            href: "https://docs.google.com/document/d/1v1f9fZvHbzmIBWXJKkLLCm43MOB3YDo-g0TW1P6c7Rw/edit?usp=sharing",

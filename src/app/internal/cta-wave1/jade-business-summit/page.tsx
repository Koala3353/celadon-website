...
export const metadata: Metadata = {
  title: "Jade Business Summit — Core Team Applications",
...
export default function JadeBusinessSummitProjectPage() {
  const project = JADE_BUSINESS_SUMMIT;
  ...
  return (
    ...
    >
      ...
      {/* What is the Jade Business Summit? + Vision */}
